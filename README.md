O Teste acima fora definido para testar o endpoint "Token". Levando em consideração os seguintes aspectos: Status Cod, Campos obrigatórios, Contrato e Autenticação da API.
